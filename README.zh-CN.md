...
- **活动账**可以把一次旅行、聚会或其他活动在不同账本中的交易归集查看，而不重复扣款。创建活动时可填日期和预算；手动记账、识图草稿及已有交易都能选择活动。活动页显示净支出、收入、分类／钱包／账本构成、每日支出和可搜索的分页明细。活动归创建者个人管理，交易仍遵守原账本权限。
