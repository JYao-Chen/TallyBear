...
export type Activity={id:string;name:string;description:string;startsOn:string|null;endsOn:string|null;budget:number|null;archived:boolean;entryCount:number};
