...
const icons={family:ArrowRightLeft,entry:NotebookPen,transaction:FilePenLine,schedule:CalendarClock,template:Bookmark,budget:ChartPie,allocation:Repeat,installment:Wallet,repayment:ArrowRightLeft};
