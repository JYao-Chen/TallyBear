export const actionNames={management:'系统管理操作',memory:'变更财务记忆',family:'家庭往来',entry:'记录账单',transaction:'变更已入账账目',schedule:'周期订阅',template:'常用一笔',budget:'设置预算',allocation:'费用分摊',installment:'建立分期',repayment:'登记还款'} as const;
