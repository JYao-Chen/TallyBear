...
export type FinanceContext={useHistory?:boolean;language?:'en'|'zh-CN';book:string;user:User;question:string;month:string;history:ChatMessage[];images:string[];signal:AbortSignal;emit:(event:string,data:any)=>void};
const specialists={
